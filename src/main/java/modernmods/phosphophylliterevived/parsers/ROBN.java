package modernmods.phosphophylliterevived.parsers;
...
public class ROBN {
    ...
    public static Element parseROBN(List<Byte> robn) {
        try {
            var robnObject = modernmods.phosphophylliterevived.robn.ROBN.fromROBN(robn);
    ...
    public static ByteArrayList parseElement(Element element) {
        try {
            return modernmods.phosphophylliterevived.robn.ROBN.toROBN(parseElementInternal(element));
