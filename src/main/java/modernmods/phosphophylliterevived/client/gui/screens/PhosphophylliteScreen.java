package modernmods.phosphophylliterevived.client.gui.screens;
...
import modernmods.phosphophylliterevived.client.gui.elements.AbstractElement;
...
public class PhosphophylliteScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> implements MenuAccess<T> {
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollX, double scrollY) {
        ...
        for (AbstractElement element : this.screenElements) {
            // Check conditions, and trigger.
            if (element != null) {
                handled = (handled || element.mouseScrolled(mouseX, mouseY, scrollX, scrollY));
            }
        }
