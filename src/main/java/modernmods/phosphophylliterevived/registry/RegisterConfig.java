...
import static modernmods.phosphophylliterevived.config.ConfigFormat.JSON5;
import static modernmods.phosphophylliterevived.config.ConfigType.COMMON;
import static modernmods.phosphophylliterevived.config.ConfigType.NULL;
