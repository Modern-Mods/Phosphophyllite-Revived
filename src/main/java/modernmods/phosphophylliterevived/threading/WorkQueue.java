package modernmods.phosphophylliterevived.threading;
        ...
        public void run() {
            while (!stop.get()) {
                ...
                try {
                    ...
                    Minecraft.crash(minecraft, minecraft.gameDirectory, new CrashReport("Exception rolled back to Phosphophyllite WorkQueue", e));
                }
            }
